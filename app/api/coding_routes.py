...
Sensitive read endpoints use the same double-submit session token as
mutations. Project roots, source diffs, task requests, process identifiers
and screenshots are private local data; only generic capability/template
metadata remains readable before the dashboard session is established.
"""
